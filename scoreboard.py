...
class Scoreboard:
    ...
    def __init__(self, ai_game):
        """Inicializa los atributos para dar informacion de la puntuacion"""
        ...
        #Prepara las imagenes de puntuacion iniciales
        self.prep_score()
    ...
    def show_score(self):
        """Dibuja la puntuaciones y nivel en la pantalla"""
        self.screen.blit(self.score_image, self.score_rect)
        self.screen.blit(self.high_score_image, self.high_score_rect)
        self.screen.blit(self.level_image, self.level_rect)


    def check_high_scoreboard(self):
